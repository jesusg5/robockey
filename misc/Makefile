...
# --------------------------------------------------------
MAIN       = main.o m_usb.o m_rf.o m_bus.o m_imu.o m_wii.o LOCOlization.o motor_driver.o moving_average.o ADC_lib.o mrf_lib.o follow_puck.o scoring_lib.o defend.o
CHILDREN   = 
PARENTS    = 
